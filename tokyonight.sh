...
reemplazar /home/pedro/.config/i3/config 224 "exec --no-startup-id bash $HOME/.config/polybar/themes/tokyo_night_theme/launch.sh"

#cambiar wallpaper
reemplazar /home/pedro/.config/i3/config 227 "exec --no-startup-id feh --bg-fill /home/pedro/Wallpaper/wallpaper-change-theme/tokyo.png"

#cambiar tema de rofi
reemplazar /home/pedro/.config/i3/config 25 'bindsym $mod+d exec --no-startup-id rofi -show drun -theme ~/.config/rofi/temas/tokyonight.rasi'
